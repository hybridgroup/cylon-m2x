...
Adaptor.prototype.updateLocation = function(id, params, callback) {
  ...
  this.m2xClient.devices.updateLocation(id, params, tmpCb);
};
...
Adaptor.prototype.trigger = function(id, triggerId, callback) {
  this.m2xClient.devices.trigger(id, triggerId, this._defCallback(callback));
};
